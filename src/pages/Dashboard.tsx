      ...
      <div className="min-h-screen pt-6 pb-24 page-transition">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <BalanceCard
            amount={
              typeof saldo === "number"
                ? saldo.toLocaleString("pt-BR", { style: "currency", currency: "SCB" })
                : "Carregando..."
            }
          />
          ...
          <CarbonCreditsCard
            amount={
              typeof saldoCredito === "number"
                ? saldoCredito.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })
                : "Carregando..."
            }
            unit="Toneladas CO₂"
          />
        ...
        <section className="mb-8 opacity-0 animate-fade-in-delayed-3">
          <div className="glass-card rounded-2xl p-5">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-base font-medium text-gray-900">Impacto Ambiental</h2>
              <span className="text-xs text-eco-green-600 bg-eco-green-100 px-2 py-1 rounded-full">+18% este ano</span>
            </div>
        ...
        <section className="mb-8">
          <h2 className="text-base font-medium text-gray-900 mb-4">Ações Rápidas</h2>
          <div className="grid grid-cols-3 gap-4">
            <ActionButton icon={ShoppingCart} label="Comprar Créditos" onClick={() => handleActionClick("buy")} color="green" />
            <ActionButton icon={TrendingUp} label="Vender Créditos" onClick={() => handleActionClick("sell")} color="blue" />
            <ActionButton icon={Send} label="Transferir" onClick={() => handleActionClick("transfer")} color="green" />
          </div>
        </section>
